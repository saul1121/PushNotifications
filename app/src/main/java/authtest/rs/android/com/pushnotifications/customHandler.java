...
/**
 * Created by superadmin on 3/18/16.
 */
public class customHandler extends BroadcastReceiver
{
    private static final String TAG = "customH>>>>>>>>";
    ...
    public void onReceive(Context context, Intent intent)
    {
        ...
        if (action.equals(PBConstants.EVENT_MSG_OPEN)) {
            ...
            String link= PushdataOpen.get("KEYS").toString();
...
/*
            if(link != null && link.equals("URL")){
                ...
                Pushbots.sharedInstance().startActivity(intentx);
...
*/
         ...
         //   resultIntent.putExtra("LINK", PushdataOpen.get("KEYX").toString()); //("", PushdataOpen.get("KEYS"));
